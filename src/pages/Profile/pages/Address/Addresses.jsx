...
const Addresses = ({ addresses, setIsOpenAddress }) => {
  return (
    <div className='mt-5 h-full md:mt-0 border-2 border-gray-300 rounded-lg px-3 py-5 md:py-3.5'>
      <div className='pb-4 border-b border-gray-300 hidden lg:flex items-center justify-between'>
